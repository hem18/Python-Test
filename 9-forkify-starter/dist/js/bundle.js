...
"use strict";
eval("\n\n//3dc41df5809aabf5f4501f5d5afa87b0\n//http://food2fork.com/api/search \n\nvar getFood = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(query) {\n        var key, jsonData;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        /* const callHeaders = new Headers({\r\n                            'key': '3dc41df5809aabf5f4501f5d5afa87b0'\r\n                        })\r\n                        const getRecipe = await fetch('http://food2fork.com/api/search?q=\\'Pizza\\'', callHeaders);\r\n                        const getData = await getRecipe.json();\r\n                        console.log(getData); */\n                        key = '3dc41df5809aabf5f4501f5d5afa87b0';\n                        jsonData = (0, _axios.axios)('http://food2fork.com/api/search?key=' + key + '&q=' + query);\n\n                        console.log(jsonData);\n\n                    case 3:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, this);\n    }));\n\n    return function getFood(_x) {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\ngetFood('Pizza');\n\n//# sourceURL=webpack:///./src/js/index.js?");
